...
export const useTasks = selectedProject => {
    ...
    useEffect(() => {
        let unsubscribe = firebase.firestore().collections('tasks').where('userId', '==', 'ymd3we58n5xu85tw')
...
export const useProjects = () => {
    ...
    useEffect(() => {
        firebase.firestore().collections('projects').where('userId', '==', 'ymd3we58n5xu85tw').orderBy('projectId').get().then(snapshot => {
